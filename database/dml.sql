-- -- Insert a user
-- INSERT INTO users (username, email, store_name, personal_name, machine_serial_number, phone_number, user_role) 
-- VALUES 
-- ('johnsmith', 'johnsmith1@example.com', 'Smith Store 1', 'John Smith 1', '123ABC', '1234567891', 'stock_manager'),
-- ('janedoe', 'janedoe@example.com', 'Doe Store', 'Jane Doe', '456DEF', '1234567892', 'customer'),
-- ('alexjohnson', 'alexjohnson@example.com', 'Johnson Store', 'Alex Johnson', '789GHI', '1234567893', 'customer'),
-- ('emilywhite', 'emilywhite@example.com', 'White Store', 'Emily White', '012JKL', '1234567894', 'stock_manager'),
-- ('michaelgreen', 'michaelgreen@example.com', 'Green Store', 'Michael Green', '345MNO', '1234567895', 'customer');
